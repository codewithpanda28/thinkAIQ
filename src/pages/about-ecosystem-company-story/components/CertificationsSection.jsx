  ...
  const certifications = [
    {
      ...
      image: "https://images.pexels.com/photos/6801648/pexels-photo-6801648.jpeg?w=300&h=200&fit=crop",
      description: "Official recognition as a Micro, Small & Medium Enterprise, enabling access to government schemes and financial incentives.",
      verificationId: "MSME-DL-07-0012345",
      status: "Active",
      benefits: [
        "Eligibility for government tenders and projects",
    ...
    },
    {
      ...
      image: "https://images.pexels.com/photos/7688336/pexels-photo-7688336.jpeg?w=300&h=200&fit=crop",
      description: "Certification for implementing a robust Quality Management System to ensure consistent product and service quality.",
      verificationId: "ISO-9001-2022-AUTH-001",
      status: "Active",
      benefits: [
    ...
    {
      id: 3,
      name: "AWS Partner Certification",
      issuer: "Amazon Web Services",
      date: "2023",
      type: "Technology Partnership",
      image: "https://images.pexels.com/photos/11035471/pexels-photo-11035471.jpeg?w=300&h=200&fit=crop",
      description: "Authorized AWS partner specializing in cloud architecture and scalable technology solutions for businesses.",
      verificationId: "AWS-PARTNER-2023-AUTHERA",
      status: "Active",
      benefits: [
        "Access to AWS technical resources and tools",
    ...
    },
    {
      ...
      description: "Certified Google Cloud partner offering AI and machine learning solutions with scalable cloud infrastructure.",
      verificationId: "GCP-PARTNER-2023-AUTHERA",
      status: "Active",
      benefits: [
        "Cloud credits and resource support",
        "Technical training for teams",
        "Go-to-market and promotional assistance",
