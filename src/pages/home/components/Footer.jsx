...
const Footer = () => {
  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        // { name: "Success Stories", href: "/home" },
    ...
    },
    {
      ...
      links: [
        ...
        // { name: "Training & Onboarding", href: "/contact" },
  ...
  return (
    <footer className="bg-gradient-to-br from-secondary via-primary/10 to-primary text-white ">
      {/* Main Footer */}
