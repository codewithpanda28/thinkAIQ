  ...
  const certifications = [
    {
      ...
      image:
        "https://images.pexels.com/photos/1181263/pexels-photo-1181263.jpeg?w=300&h=200&fit=crop",
      description:
      ...
      url: "https://example.com/verify/MSME-KOL-2020-GWDA", // <-- Add your URL here
      status: "Verified",
      benefits: [
    ...
    },
    {
      ...
      image:
        "https://images.pexels.com/photos/3184325/pexels-photo-3184325.jpeg?w=300&h=200&fit=crop",
      description:
    ...
    },
    {
      ...
      image:
        "./../../../assets/images/certificate/Screenshot 2025-11-12 122916.png",
      description:
      ...
      status: "Verified",
      url: "https://www.udemy.com/certificate/UC-dd736444-5a5f-43b6-a28c-4907d80d2139/", // <-- Add your URL here
      benefits: [
    ...
    },
    {
      ...
      image:
        "./../../../assets/images/certificate/Screenshot 2025-11-12 122932.png",
      description:
      ...
      url: "https://www.mygreatlearning.com/certificate/CXBCQITH", // <-- Add your URL here
      status: "Verified",
      benefits: [
  ...
  const awards = [
    {
      ...
      category: "Innovation",
      image:
        "https://images.pexels.com/photos/1181533/pexels-photo-1181533.jpeg?w=300&h=200&fit=crop",
      description:
        "Recognized for delivering innovative AI automation solutions that have transformed business processes for MSMEs.",
  ...
  const partnerships = [
    {
      ...
      description:
        "Strategic partnership to deliver Azure cloud-based solutions and AI-enabled business services.",
      benefits: [
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Our credibility is backed by industry certifications, awards, and
          ...
          {activeTab === "certifications" && (
            <div className="grid md:grid-cols-2 gap-8">
              {certifications.map((cert) => (
                <div
                  key={cert.id}
                  className="bg-background border border-border rounded-2xl overflow-hidden shadow-brand-md hover:shadow-brand-lg transition-all duration-300"
                >
                  ...
                  <div className="p-6">
                    ...
                    <Button
                      ...
                      iconPosition="right"
                      className="mt-4"
                      onClick={() => window.open(cert.url, "_blank")} // <-- URL new tab me open hoga
                    >
                      Verify Certificate
                    </Button>
                  </div>
          ...
          {activeTab === "partnerships" && (
            <div className="grid md:grid-cols-2 gap-8">
              {partnerships.map((partner) => (
                <div
                  key={partner.id}
                  className="bg-background border border-border rounded-2xl p-6 shadow-brand-md hover:shadow-brand-lg transition-all duration-300"
                >
