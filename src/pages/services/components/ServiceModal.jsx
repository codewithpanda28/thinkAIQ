...
const allServiceDetails = {
  ...
  "ai-hr-automated-hiring-system": {
    id: 2,
    name: "AI HR — Automated Hiring System",
    tagline:
      "End-to-end automated hiring with AI screening & WhatsApp assistant",
    ...
    longDescription:
      "Streamline your hiring process with AI HR — Automated Hiring System. Automate job postings, bulk resume screening, candidate scoring, interview scheduling, and onboarding. Engage candidates seamlessly via WhatsApp with smart notifications, reminders, and follow-ups. Reduce HR workload by 90% while ensuring bias-free evaluation and high accuracy.",

    icon: "UserCheck",
    color: "from-purple-500 to-pink-600",
    image:
      "https://cdn.dribbble.com/userupload/45852477/file/b167e142560d75eb19e7291a078b4abe.jpg",
    images: [
      "https://cdn.dribbble.com/userupload/45852477/file/b167e142560d75eb19e7291a078b4abe.jpg",
      "https://cdn.dribbble.com/userupload/45852477/file/b167e142560d75eb19e7291a078b4abe.jpg",
      "https://cdn.dribbble.com/userupload/45852477/file/b167e142560d75eb19e7291a078b4abe.jpg",
    ...
    benefits: [
      "Reduces HR workload by 90%",
      "Faster candidate shortlisting",
      "Bias-free evaluations",
      "Seamless WhatsApp engagement",
      "High accuracy in hiring decisions",
    ],
    ...
    useCases: [
      ...
      "WhatsApp notifications & onboarding",
      "Bulk hiring for startups & enterprises",
    ...
    video: "https://via.placeholder.com/800x400?text=YouTube+Coming+Soon",
  },
};
                ...
                <div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    {service.features?.map((feature, idx) => (
                      <div
                        key={idx}
                        className="flex items-start space-x-2 p-3 bg-muted/30 dark:bg-muted rounded-lg"
                      >
                        <Icon
                          name="Check"
                          size={16}
                ...
                <div>
                  <h3 className="text-xl font-semibold text-foreground mb-4 flex items-center">
                    <Icon
                      name="TrendingUp"
                      size={20}
                      className="text-primary dark:text-accent mr-2"
                    />
                    Key Benefits
                  </h3>
                    ...
                    {service.benefits?.map((benefit, idx) => (
                      ...
                      >
                        <Icon
                          name="ArrowRight"
                          size={16}
                          className="text-primary dark:text-accent flex-shrink-0 mt-0.5"
                        />
                        <span>{benefit}</span>
                      </li>
                    ))}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {service.technologies?.map((tech, idx) => (
                      <span
                        key={idx}
                        className="px-4 py-2 bg-muted dark:bg-muted rounded-full text-sm text-foreground font-medium"
                      >
                        {tech}
                      </span>
                    ))}
                ...
                <div>
                  ...
                  <div className="grid sm:grid-cols-2 gap-2">
                    {service.useCases?.map((useCase, idx) => (
                      <div
                        key={idx}
                        className="p-3 bg-muted/30 dark:bg-muted rounded-lg text-sm text-foreground"
                      >
                        {useCase}
                      </div>
                    ))}
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {service.industries.map((industry, idx) => (
                        <span
                          key={idx}
                          className="px-3 py-1 bg-primary/10 dark:bg-accent/20 text-primary dark:text-accent rounded-full text-sm"
                        >
                          {industry}
                        </span>
                      ))}
